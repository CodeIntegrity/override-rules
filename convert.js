...
支持的传入参数：
- grouptype: 地区代理组类型（0=select 手动选择, 1=url-test 自动测速, 2=load-balance 负载均衡, 3=smart 智能选路，默认 1）
...
(() => {
  ...
  function parseSmartFallback(args) {
    const raw = parseNumber(args.smartfallback, 0);
    if (raw === 0 || raw === 1 || raw === 2) return raw;
    return 0;
  }
  function parseSmartExclude(raw) {
    if (!raw) return [];
  ...
  function buildProxyGroups({
    ...
    const groups = [
      ...
      ...countryNames.map((country) => {
        ...
        if (!meta) return null;
        const effectiveType = groupType === 3 && smartExcludeSet.has(country) ? smartFallback : groupType;
    ...
    "src/rule_providers.ts"() {
      ...
      ruleProviders = {
        ...
        TikTok: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/CodeIntegrity/override-rules@master/ruleset/TikTok.list`,
        ...
        EHentai: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/CodeIntegrity/override-rules@master/ruleset/EHentai.list`,
        ...
        SteamFix: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/CodeIntegrity/override-rules@master/ruleset/SteamFix.list`,
        ...
        GoogleFCM: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/CodeIntegrity/override-rules@master/ruleset/FirebaseCloudMessaging.list`,
        ...
        AdditionalFilter: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/CodeIntegrity/override-rules@master/ruleset/AdditionalFilter.list`,
        ...
        AdditionalCDNResources: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/CodeIntegrity/override-rules@master/ruleset/AdditionalCDNResources.list`,
        ...
        Crypto: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/CodeIntegrity/override-rules@master/ruleset/Crypto.list`,
        ...
        Weibo: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/CodeIntegrity/override-rules@master/ruleset/Weibo.list`,
  ...
  var require_main = __commonJS({
    "src/main.ts"() {
      ...
      function main(config) {
        ...
        const activeNodes = landing ? nonLandingNodes : config.proxies;
